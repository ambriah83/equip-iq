    ...
    <Card className="hover:shadow-lg transition-shadow">
      ...
      <CardContent>
        <div className="space-y-3">
          ...
          {(equipment.equipmentPhoto || equipment.documentation || equipment.warrantyDocumentation || equipment.roomLayout || equipment.roomPhoto) && (
            <div className="pt-2 border-t">
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                {equipment.warrantyDocumentation && equipment.warrantyDocumentation.length > 0 && (
                  <Badge variant="outline" className="text-xs">
                    <Shield size={12} className="mr-1" />
                    Warranty ({equipment.warrantyDocumentation.length})
                  </Badge>
                )}
          ...
          <div className="pt-2 border-t">
            <p className="text-xs text-slate-500">Warranty: {equipment.warranty}</p>
          </div>
        </div>
      </CardContent>
    </Card>
